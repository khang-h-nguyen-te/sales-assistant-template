(function () {
  ...
  iframe.src =
    "https://sales-assistant-template-pi.vercel.app?mode=button" +
    (isInWix ? "&wix=true" : "");
  iframe.title = "PHỞ24® AI Assistant Chat Widget";
  ...
  function toggleChat(mode) {
    if (mode === "expand") {
      ...
      setTimeout(() => {
        iframe.src =
          "https://sales-assistant-template-pi.vercel.app?mode=chat" +
          (isInWix ? "&wix=true" : "");
      }, 10);
    } else {
  ...
  window.addEventListener("message", function (event) {
    ...
    if (event.origin !== "https://sales-assistant-template-pi.vercel.app")
      return;
